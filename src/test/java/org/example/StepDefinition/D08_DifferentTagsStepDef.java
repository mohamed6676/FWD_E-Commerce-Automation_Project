...
import org.example.Pages.P08_DifferentTagsPage;
import org.openqa.selenium.By;
import org.openqa.selenium.WebElement;
import org.testng.Assert;

public class D08_DifferentTagsStepDef {
    P08_DifferentTagsPage tagsPage=new P08_DifferentTagsPage();
    ...
    public void select_cool_from_popular_tags() throws InterruptedException {
        ...
        Assert.assertTrue(actual.contains(expected),"Cool tag is selected");
        Thread.sleep(1000);
    }
